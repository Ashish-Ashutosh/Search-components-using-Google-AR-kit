...
public class AugmentedImageRenderer {
  ...
  public void createOnGlThread(Context context) throws IOException {
    ...
    imageFrameUpperLeft.createOnGlThread(
            context, "models/salle.obj", "models/salle.png");
  ...
  public void draw(
      ...
      Anchor centerAnchor,
      float[] colorCorrectionRgba,ComponentDetail comDetail) {
    ...
    Pose[] localBoundaryPoses = {
      Pose.makeTranslation(
              comDetail.posx * augmentedImage.getExtentX(),
               comDetail.posy,
              comDetail.posz * augmentedImage.getExtentZ()) // upper left
    };
